...
Utilizan la función gaussiana donde <p>$\sigma =\sqrt{2Kt} $ </p> y &mu; representa la posición del puff en cada instante.
...
donde Q es tasa de emisión, y <p>$\sigma=\sqrt{2Kx/u}$</p>.
