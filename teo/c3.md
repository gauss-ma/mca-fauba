...
A grandes razgos se puede asumir que G=0.1 R<sub>n</sub>. y la relación entre el calor sensible y latente depende de la cobertura de suelo y la disponibilidad de agua en el mismo, un parámetro que las relaciona es el "Ratio de Bowen" B<sub>0</sub> = &lambda; E / H.
...
<center>
H = 0.9 R<sub>n</sub> / 1 + 1/ B<sub>0</sub>
</center>
