...
+ **Introducción:** Redactar una breve introducción al sitio de estudio y proceso.
   ...
   - Breve descrpición de la meteorología del sitio (Vientos y temperatura).
...
+ **Entradas al modelo:**
   ...
   - Resumir en una tabla los parametros de emisión utilizados.
...
+ **Salidas del modelo & Resultados:**
   ...
   - Comparar concentración máxima calculada con  estándares de calidad de aire para el compuesto asignado y concluir el informe explicitando si cumple o no cumple con el estandar (de no cumplir aclarar la mangnitud del desvío).
